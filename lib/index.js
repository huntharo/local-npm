...
var pause = util.promisify((a, f) => setTimeout(f, a));
...
module.exports = (options, callback) => {
        ...
        try {
            ...
            try {
                ...
                if (dist.shasum !== localSha) {
                    ...
                    // Update stats before ending response
                    // This helps prevent conflicting updates
                    await UpdateDownloadStatsAsync(pkgName, pkgVersion);
                ...
                const location = await getRemoteTarLocationAsync(dist);
    ...
    async function VersionInfoAsync(req, res) {
        try {
            ...
            logger.error('unexpected exception in VersionInfoAsync',
